...
The code chunk below will install and load tidyverse and sd packages.
...
This code chunk will import ESRI shapefile in R.
...
**Quiz:** What is the meaning of "Average number of links: 3.681818" shown above? ANS: Each of region have average 3.68 links.
...
Characteristics of weights list object: Neighbour list object: Number of regions: 88 Number of nonzero links: 448 Percentage nonzero weights: 5.785124 Average number of links: 5.090909

Weights style: B Weights constants summary: n nn S0 S1 S2 B 88 7744 8.786867 0.3776535 3.8137
...
Question: Can you see the meaning of Spatial lag with row-standardized weights now? We can append the spatially lag GDPPC values onto hunan sf data frame by using the code chunk below.
